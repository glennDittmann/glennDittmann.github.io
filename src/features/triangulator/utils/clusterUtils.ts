...
import type { ClusterBounds2 } from "../types/ClusterBounds2";
...
export const clusterSorters = {
   ...
   */
  byVertexCount: (a: Cluster2, b: Cluster2) => b.vertices.length - a.vertices.length,

  /**
   * Sort clusters by area (descending)
   */
  byArea: (a: Cluster2, b: Cluster2) => getClusterArea(b.bounds) - getClusterArea(a.bounds),
...
export const clusterFilters = {
   ...
   */
  byMinArea: (minArea: number) => (cluster: Cluster2) => getClusterArea(cluster.bounds) >= minArea,

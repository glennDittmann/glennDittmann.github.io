...
// Selectors
export const selectTriangulationMethod = (state: { clustering: ClusteringState }) =>
  state.clustering.method;
export const selectGridSize = (state: { clustering: ClusteringState }) => state.clustering.gridSize;
export const selectClusters = (state: { clustering: ClusteringState }) => state.clustering.clusters;
export const selectSimplifiedVertices = (state: { clustering: ClusteringState }) =>
  state.clustering.simplifiedVertices;
export const selectIsClusteringComplete = (state: { clustering: ClusteringState }) =>
  state.clustering.isClusteringComplete;
export const selectIsSimplificationComplete = (state: { clustering: ClusteringState }) =>
